...
namespace NoConsoleLib
{
    public class ConsoleCommand
    {
        ...
        // standardInputData - can be null.
        public void Execute(string fileName, string arguments, string working_directory, TimeSpan timeout, string standardInputData)
        {
            using (Process process = new Process())
            {
                ...
                DateTime end_time = DateTime.Now + timeout;
